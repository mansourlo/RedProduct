    ...
    return(
        <div className="px-1">
            ...
            <nav className="text-white text-md font-bold">
                <span className="flex gap-2 mb-4 py-2 hover:bg-white hover:text-[#2d2f33] cursor-pointer">
                    <LayoutDashboard/> Dashboard
                </span>
                <span className="flex gap-2 py-2 hover:bg-white hover:text-[#2d2f33] cursor-pointer">
